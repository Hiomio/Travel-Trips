          ...
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-col items-center mb-4 md:mb-0">
              ...
              <div className="flex flex-col mt-8 text-center md:text-left">
                <p className="mb-2">Address: Near Mysore , Karnataka , India</p>
                <p className="mb-2">Phone: +91 7890345678</p>
                <p className="mb-2">Email: connect@tripstravels.in</p>
                <p>&copy; 2025 Trips Travels. All rights reserved.</p>
              </div>
            </div>
